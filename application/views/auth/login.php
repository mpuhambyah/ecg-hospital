            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="mx-5" style="margin-top:50%">
                        <h4 class="text-dark font-weight-normal">Websiteee <span class="font-weight-bold"><?= $profile['title'] ?></span></h4>
                        ...
                        <form class="user" method="POST" action="<?= base_url('auth'); ?>">
                            ...
                            <div class="form-group">
                                <div class="d-block">
                                    <label for="password" class="control-label">Password (default password adalah 000000)</label>
                                </div>
                        ...
                        <div class="text-center mt-5 text-small">
                            Copyright &copy; <?= $profile['title'] ?>. Made by Stisla
                        </div>
                    </div>
                </div>
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?= base_url() ?>assets/img/dokter/bg.jpg">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                <h1 class="mb-2 display-4 font-weight-bold"><?= $profile['title'] ?></h1>
                                <h5 class="font-weight-normal text-muted-transparent"><?= $profile['description'] ?></h5>
                            </div>
                        </div>
                    </div>
                </div>
