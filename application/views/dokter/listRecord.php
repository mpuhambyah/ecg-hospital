                        ...
                        <div class="table-responsive table-invoice">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url() ?>dokter/download   " class="btn btn-primary">Download</a>
                                        <a href="<?= base_url() ?>dokter/record/1/1" class="btn btn-info">Detail</a>
                                        <a href="<?= base_url() ?>dokter/deletePasien/1/1" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                                <tr>
